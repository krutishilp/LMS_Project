<div id="Upload2" class="updesc">
      <h4>Upload File</h4>
      <form action='teacher.php' method='POST' enctype='multipart/form-data'>
            <input type='file' name='fl' required><br><br>
            ...
            <input type='submit' value='Upload' name='upldFile'><br>
      </form>
</div>
<div id="Upload3" class="updesc" style="display: none;">
      <h4>Upload Video Link</h4>
      <form action='teacher.php' method='POST' enctype='multipart/form-data'>
            <input type='text' name='fileName' placeholder="Please enter video link here." required><br><br>
            <select name='unit' required>
                  <option value="" disabled selected>Select Unit</option>
                  <option value='1'>1</option>
                  <option value='2'>2</option>
            ...
            <input type='submit' value='Upload' name='upldLink'><br>
      </form>
</div>
<?php
