...
<input type="text" id="seminar_title" name="seminar_title"><br><br>
<label for="file_seminar">Notice</label><br>
<input type="file" id= "file_seminar"  name="fl"/><br><br>
...
<input type="text" id="feedback_link" name="feedback_link"><br><br>
<label for="feedback_date">Form Deadline: </label>
<input type="date" id="feedback_date" name="feedback_date" placeholder="feedback Date" style="width: 75%;"><br><br>
