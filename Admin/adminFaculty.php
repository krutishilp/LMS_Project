           <div id="faculty" style="display: none;">
             ...
             <div class="table-responsive pad">
               <table class="table table-bordered  table-striped">
                 ...
                 <?php
                  $q = "SELECT * FROM teachers ORDER BY name asc";
             ...
             <div class="row pad" style="width: 100%; ">
               <div class="col-lg-4 sm-12 md-12 pad">
                 ...
                 <form class="fc" method="post" action="admin.php"><input type="email" name="email" placeholder="Faculty Email"><br><br><input type="submit" name="mkadmin" value="Make Admin"></form>
               </div>
               <div class="col-lg-4 sm-12 md-12 pad">
               ...
               <div class="col-lg-4 sm-12 md-12 pad">
                 ...
                 <form class="fc" method="post" action="admin.php"><input type="text" name="sub" placeholder="Subject Name"><br><br><input type="submit" name="delsub" value="Delete"></form>
               </div>
             </div>
